...
export const App: FC<{ name: string }> = ({ name }) => {
  ...
  return (
    <div>      
      <Sidebar isOpen={sidebarOpen} toggleSidebar={toggleSidebar} title='side2bar' />
      <header>
        <h1>Hello {name}!</h1>
      ...
      <cardframe>
        <Card title='Ace' subtitle='sAce' text='Ace cardo is the first card. Often, this card is hidden from the players.  And you should find it out by chance.' url_label='Find out here' url='#' css_class='poker_spade_ace' />
        <card class="meeru-island">
          <div>
            <h2>Javascript & React</h2>
            <p>The 2 languages are of importance in this and coming decade and we will look for students who endeavour to learn these programming languages</p>
            <a href="#">Learn more</a>
          </div>
        </card>
